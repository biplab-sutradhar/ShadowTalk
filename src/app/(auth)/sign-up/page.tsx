...
const Page = () => {
  ...
  // Debounced function for checking username uniqueness
  const checkUsernameUnique = useDebounceCallback(async (debouncedUserName) => {
    if (debouncedUserName.length < 3) {
      setUserNameMessage(""); // Clear message if too short
      return;
    }
  ...
  useEffect(() => {
    checkUsernameUnique(userName); // Call the debounced function
